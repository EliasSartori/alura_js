...
System.register(['../models/ListaNegociacoes', '../models/Negociacao', '../models/Mensagem', '../views/MensagemView', '../views/NegociacoesView', '../helpers/Bind', '../helpers/DateHelper', '../services/NegociacaoService'], function (_export, _context) {
    "use strict";

    var ListaNegociacoes, Negociacao, Mensagem, MensagemView, NegociacoesView, Bind, DateHelper, NegociacaoService, _createClass, NegociacaoController;
